...
export function SidebarUser({ role }: { role: UserRole }) {
  ...
  const Icon = role === "SuperUser" ? Crown : role === "Admin" ? ShieldCheck : Store;
  return (
    <div className="flex items-center gap-2.5 px-3 py-2" title={`${name} (${role === "SuperUser" ? "Super User" : role})`}>
