    ...
    <>
      <aside className="hidden w-[260px] border-r border-slate-200 bg-[#f7f5f3] lg:flex lg:flex-col">
        <div className="flex items-center gap-3 border-b border-slate-200 px-6 py-5">
          ...
          <div className="text-lg font-semibold">WayFair</div>
        </div>
            ...
            return (
              <a
                ...
                className={`group flex items-center gap-3 rounded-r-xl border-l-2 px-3 py-3 text-sm font-medium transition-colors ${
                  active ? "border-[var(--brand)] bg-[color-mix(in_srgb,var(--brand)_8%,white)] text-[var(--brand)]" : "border-transparent text-slate-600 hover:bg-white hover:text-slate-900"
                }`}
              >
...
export default function SellerLayout({ children }: { children: ReactNode }) {
  ...
  return (
    <NotificationsProvider role="Seller">
