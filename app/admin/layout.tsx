...
import { ChartNoAxesCombined, CreditCard, House, Menu, MessageSquareText, Package, Settings, ShieldCheck, ShoppingBag, UserRound, Users, WalletCards, X } from "lucide-react";
            ...
            return (
              <a
                ...
                className={`group flex items-center gap-3 rounded-r-xl border-l-2 px-3 py-3 text-sm font-medium transition-colors ${
                  active
                    ? "border-[#f0563f] bg-[#fdf2ef] text-[#f0563f]"
